...
\textit{(Fig. 51}\footnote{This figure does not contain any such
  hole.}).  You will have to use a brace and bit to drill a hole
\circled{164} as seen at \circled{165}, and use a rasp to fit it to
the diameter of the tube, \textit{i.e.} 24mm.
